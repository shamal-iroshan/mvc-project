...
public class AddCustomerController {
    ...
    public AddCustomerController() throws ClassNotFoundException, SQLException {
    ...
    public String getCustomerID() throws SQLException {
        ...
        if(rst.next()){
            ...
            id++;
            if(id<10){return "C000"+id;}
            else if(id<100){return "C00"+id;}
            else if(id<1000){return "C0"+id;}
            else{return "C"+id;}
        }else{
            return "C0001";
        }
