 ...
 * @author Shamal
 */
public class PurchaseMain extends javax.swing.JInternalFrame {
    Main main;
    boolean state;
    /** Creates new form PurchaseMain */
    public PurchaseMain(Main main, boolean state) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnMakepurchase.setIcon(new javax.swing.ImageIcon(getClass().getResource("/lk/ijse/moderntech/img/icons8_add_30px.png"))); // NOI18N
        ...
        btnDeletepurchase.setIcon(new javax.swing.ImageIcon(getClass().getResource("/lk/ijse/moderntech/img/icons8_delete_sign_30px.png"))); // NOI18N
        btnDeletepurchase.setText("Delete Purchase");
    ...
    private void setTheme(boolean state) {
        if (state) {
            ...
            btnMakepurchase.setkBackGroundColor(new Color(99, 100, 100));
            btnMakepurchase.setForeground(Color.WHITE);
            btnMakepurchase.setkForeGround(Color.WHITE);
            btnDeletepurchase.setkBackGroundColor(new Color(99, 100, 100));
            btnDeletepurchase.setForeground(Color.WHITE);
            btnDeletepurchase.setkForeGround(Color.WHITE);
        } else {
            ...
            btnMakepurchase.setkBackGroundColor(new Color(230, 230, 230));
            btnMakepurchase.setkForeGround(Color.BLACK);
            btnDeletepurchase.setkBackGroundColor(new Color(230, 230, 230));
            btnDeletepurchase.setkForeGround(Color.BLACK);
        }
    }
