 ...
 * @author Shamal
 */
public class AddCustomer_quick extends javax.swing.JDialog implements AddCustomerInterface {
    ...
    /**
     * Creates new form AddCustomer_quick
     */
    public AddCustomer_quick(java.awt.Frame parent, boolean modal, PurchaseBill bill) {
        super(parent, modal);
        initComponents();
        this.setModal(true);
    ...
    private void lblCloseMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblCloseMouseClicked
        if (id == null || name == null) {
            bill.cmbCustomerid.setSelectedItem("C0001");
            bill.txtCstomername.setText("Cash customer");
            this.dispose();
        } else {
            bill.cmbCustomerid.setSelectedItem(id);
            bill.txtCstomername.setText(name);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddCustomer_quick.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddCustomer_quick dialog = new AddCustomer_quick(new javax.swing.JFrame(), true, null);
